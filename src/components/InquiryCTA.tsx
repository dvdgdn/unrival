  ...
  return (
    <section id="inquiry" style={{margin:'24px 0', padding:'16px', border:'1px solid #D0D8E2', borderRadius:8}}>
      ...
      <div style={{ textAlign: 'center' }}>
        <a href={formURL} target="_blank" rel="noopener noreferrer" className="btn-primary" onClick={()=>window.gtag?.('event','inquiry_cta_click',{placement:'hero'})}>Add your entry (2 min)</a>
      </div>
      <style jsx>{`

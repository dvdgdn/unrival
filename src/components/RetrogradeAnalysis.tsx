...
const timelineData = [
    {
        ...
        tasks: [
            ...
            { id: 'q3-task-custom2', text: 'Experimental public promise ledger published', checked: true },
...
const RetrogradeAnalysis = () => {
    ...
    // This provides a visual "boost" to the early tasks, making initial progress more noticeable.
